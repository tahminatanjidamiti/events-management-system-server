...
router.post("/friend", (0, auth_1.default)(client_1.Role.USER), (0, validateRequest_1.default)(social_validation_1.SendFriendRequestSchema), social_controller_1.SocialController.sendFriendRequest);
router.patch("/friend", (0, auth_1.default)(client_1.Role.USER), (0, validateRequest_1.default)(social_validation_1.FriendActionSchema), social_controller_1.SocialController.handleFriendAction);
router.get("/friend", (0, auth_1.default)(client_1.Role.USER), social_controller_1.SocialController.listFriendRequests);
router.post("/follow", (0, auth_1.default)(client_1.Role.USER), (0, validateRequest_1.default)(social_validation_1.FollowSchema), social_controller_1.SocialController.followUser);
